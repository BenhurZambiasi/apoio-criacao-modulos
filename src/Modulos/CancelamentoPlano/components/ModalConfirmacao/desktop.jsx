    ...
    <div className="modal-content-cancelamento">
      <div className="content-cancelamento">
        <div className="title">
          <div>
            <h1>
              Ao confirmar a solicitação será enviado para a sua Unimed o pedido
              de cancelamento do plano de saúde para o(s) seguinte(s)
              beneficiário(s):
            </h1>
          </div>
        </div>
          ...
          <div className="content-doc-cancelamento">
            ...
            <p>
              ...
              <p>
                ...
                individual ou familiar ou de exclusão de beneficiários em plano
                coletivo empresarial ou coletivo por adesão, a operadora ou
                administradora de benefícios, destinatária do pedido, deverá
                prestar de forma clara e precisa, no mínimo, as seguintes
                informações:
              </p>
            </p>
